...
if ($_SESSION['mod'] == 'upgrade') {
    ...
    fclose($fh);
    $display_text = 'Your system has been successfully upgraded to version 7.3. Please click the button below<br/> to proceed to login with your existing login credentials.
';
    echo '<!DOCTYPE html>
        <html lang="en">
            <head>
