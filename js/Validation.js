...
//    frmvalidator.addValidation("values[people][OTHER][EMAIL]", "email", "Please enter a valid additional emergency email");
    ...
    frmvalidator.addValidation("assign_student_id", "num", "College Roll No allows only numeric value");
...
function passwordMatch()
{
    ...
    if (new_pass || vpass)
    {
        ...
        {
            $('#passwordMatch').show();
            $('#passwordMatch').css({color: '#4caf50'}).html('<i class="icon-notification2"></i> Password Match');
        }
