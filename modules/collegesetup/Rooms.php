...
if (clean_param($_REQUEST['modfunc'], PARAM_ALPHAMOD) == 'remove' && AllowEdit()) {
    ...
    if ($has_assigned > 0) {
        $qs = 'Modules.php?modname=collegesetup/Rooms.php';
...
if ($_REQUEST['modfunc'] != 'remove') {
    $sql = "SELECT  ROOM_ID,TITLE,TITLE as NAME,CAPACITY,DESCRIPTION,SORT_ORDER FROM rooms WHERE college_id='" . UserCollege() . "' ORDER BY sort_order";
    $QI = DBQuery($sql);
