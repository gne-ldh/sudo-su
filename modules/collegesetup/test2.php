 ...
 */
  ...
  $colmn = Calender_Id;
    ...
    $message .= '<div class="checkbox"><label><INPUT type=checkbox name=default value=Y ' . (($acs_RET['DEFAULT_CALENDAR'] == 'Y') ? 'checked' : '') . '> Default Calendar for this College</label></div>';
    $message .= '</div>';
